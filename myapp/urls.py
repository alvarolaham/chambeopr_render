...
urlpatterns = [
    ...
    path("upload_profile_picture_dashboard/", upload_profile_picture_dashboard, name="upload_profile_picture_dashboard"),
    path("delete_profile_picture/", delete_profile_picture, name="delete_profile_picture"),
    path("get_user_profile_pic/", get_user_profile_pic, name="get_user_profile_pic"),
    ...
    path("api/get-rates-and-services/", get_rates_and_services, name="get_rates_and_services"),
    path("api/update-availability/", update_availability, name="update_availability"),
